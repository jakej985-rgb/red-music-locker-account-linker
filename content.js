// Content script injected into music.youtube.com for Red Music Locker
(function () {
  ...
  function ensureBanner() {
    ...
    style.textContent = `@keyframes rml-spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }`;
    (document.head || document.body).appendChild(style);

    banner = document.createElement("div");
    banner.id = "red-music-locker-banner";
    ...
    spinner.id = "rml-spinner";
    spinner.style.cssText = "width: 12px; height: 12px; border: 2px solid #e53935; border-top-color: transparent; border-radius: 50%; animation: rml-spin 1s linear infinite;";

    headerTitle = document.createElement("strong");
    headerTitle.style.fontSize = "15px";
    headerTitle.textContent = "Red Music Locker";
    ...
    statusEl.id = "rml-status";
    statusEl.style.cssText = "color: #aaa; font-size: 13px; line-height: 1.4;";
    statusEl.textContent = "Linking YouTube Music account to your Red Music Locker server...";
    banner.appendChild(statusEl);

    buttonRow = document.createElement("div");
    buttonRow.id = "rml-button-row";
  ...
  chrome.runtime.sendMessage(
    ...
    (response) => {
      ...
      if (statusEl) {
        ...
        line2.textContent = "You can now close this tab and return to Red Music Locker.";
